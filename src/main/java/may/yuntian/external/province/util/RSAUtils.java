...
public class RSAUtils {
    ...
    public static Map<String, Key> initKey(String seed) throws Exception {
        ...
        // 如果指定seed，那么secureRandom结果是一样的，所以生成的公私钥也永远不会变  // ToDo:如若生成随机密钥对，注释掉该行代码即可。
...
//		BASE64Encoder encoder = newCommission BASE64Encoder();
...
//		BASE64Decoder decoder = newCommission BASE64Decoder();
