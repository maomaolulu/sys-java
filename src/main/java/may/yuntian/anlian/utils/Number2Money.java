...
//            }
    ...
    /**
     * 避免类型转换导致的精度丢失公用的计算方法
     * @param v1
     * @param v2
     * @return
     */
    public static BigDecimal subtance(BigDecimal v1, Float v2) {
        BigDecimal a = new BigDecimal(v2.toString());
        BigDecimal c = new BigDecimal(v1.toString());
        return c.subtract(a);
    }
    ...
    public static Map<String, Object> getPageInfo(Map<String, Object> params){
        params.put("page",(String)params.get("pageIndex"));
        params.put("limit",(String)params.get("pageSize"));
        return params;
    }
