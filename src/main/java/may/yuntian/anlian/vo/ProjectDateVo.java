 ...
 * 项目日期查询
 */
public class ProjectDateVo implements Serializable {
     ...
     * 报告封面日期开始
     */
    private String reportCoverDateStart;
    /**
     * 报告封面日期结束
     */
    private String reportCoverDateEnd;
    /**
     * 报告封面日期开始
     */
    ...
    public String getReportCoverDateStart() {
        return reportCoverDateStart;
    }

    public void setReportCoverDateStart(String reportCoverDateStart) {
        this.reportCoverDateStart = reportCoverDateStart;
    }

    public String getReportCoverDateEnd() {
        return reportCoverDateEnd;
    }

    public void setReportCoverDateEnd(String reportCoverDateEnd) {
        this.reportCoverDateEnd = reportCoverDateEnd;
    }
